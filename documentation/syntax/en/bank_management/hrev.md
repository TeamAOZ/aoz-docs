...
Return a flag of bits to be used in Bob and Sprite instructions that will mirror the image horizontally
- **imageIndex**: Index of the image in the Images bank (this function does not work with string indexes)
---
