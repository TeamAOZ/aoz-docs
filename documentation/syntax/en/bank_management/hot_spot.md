...
Returns the coordinate of the hot-spot of an image in the Images bank
- **imageIndex**: Index of the image in the Images bank
- **direction&dollar;**: Use "x" to get the horizontal position or "y" to get the vertical position
---
