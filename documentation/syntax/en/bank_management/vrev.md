...
Return a flag of bits to be used in Bob and Sprite instructions that will mirror the image vertically
- **imageIndex**: Index of the image in the Images bank, can only a number for this function,.
---
