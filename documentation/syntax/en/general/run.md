...
Execute another AOZ program
- _path_ (optional):  The path of the program to execute
- _commandLine&dollar;_ (optional):  Eventual parameters to transmit to the new applicaton
---
