...
Switch on Underline setting for printing in the current text window.
- **width**: Optional. Width of the line used to underline the text. Default width is 2 if omitted.
---
